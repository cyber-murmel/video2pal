...
# Title: Pal Transmit
# Generated: Sun Oct  7 18:56:15 2018
##################################################
...
class pal_transmit(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_c([1]*samp_line, True, samp_line, [])
        self.blocks_uchar_to_float_0 = blocks.uchar_to_float()
        self.blocks_sub_xx_0 = blocks.sub_cc(samp_line)
        ...
        self.blocks_stream_to_vector_1 = blocks.stream_to_vector(gr.sizeof_gr_complex*samp_line/2, 2)
        ...
        self.blocks_null_source_0_1_0_0_0 = blocks.null_source(gr.sizeof_gr_complex*samp_visual)
        self.blocks_null_source_0_1_0_0 = blocks.null_source(gr.sizeof_gr_complex*samp_visual)
        self.blocks_null_source_0_1_0 = blocks.null_source(gr.sizeof_gr_complex*samp_burst)
        self.blocks_null_source_0_1 = blocks.null_source(gr.sizeof_gr_complex*samp_burst)
        self.blocks_null_source_0_0_1 = blocks.null_source(gr.sizeof_float*samp_visual)
        self.blocks_null_source_0_0_0 = blocks.null_source(gr.sizeof_float*samp_visual)
        self.blocks_null_source_0_0 = blocks.null_source(gr.sizeof_float*samp_visual)
        self.blocks_null_source_0 = blocks.null_source(gr.sizeof_float*samp_visual)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vff(([0.00390625/2]*3*samp_visual*lines_visual))
        ...
        self.blocks_add_xx_0 = blocks.add_vcc(samp_line)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_stream_to_streams_1, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_stream_to_vector_0_0_0, 0))
        self.connect((self.blocks_multiply_xx_2, 0), (self.blocks_vector_to_stream_0_1, 0))
        self.connect((self.blocks_null_source_0, 0), (self.blocks_stream_mux_3, 0))
        self.connect((self.blocks_null_source_0_0, 0), (self.blocks_stream_mux_3, 2))
        self.connect((self.blocks_null_source_0_0_0, 0), (self.blocks_stream_mux_3_0, 0))
        self.connect((self.blocks_null_source_0_0_1, 0), (self.blocks_stream_mux_3_0, 2))
        self.connect((self.blocks_null_source_0_1, 0), (self.blocks_stream_mux_4, 2))
        self.connect((self.blocks_null_source_0_1_0, 0), (self.blocks_stream_mux_4, 0))
        self.connect((self.blocks_null_source_0_1_0_0, 0), (self.blocks_stream_mux_1_1_0, 2))
        self.connect((self.blocks_null_source_0_1_0_0_0, 0), (self.blocks_stream_mux_1_1_0, 0))
        self.connect((self.blocks_stream_mux_0, 0), (self.blocks_stream_mux_2_1, 3))
        self.connect((self.blocks_stream_mux_1, 0), (self.blocks_stream_to_vector_1, 0))
        ...
        self.connect((self.blocks_stream_to_vector_0_0_0, 0), (self.blocks_add_xx_0, 1))
        ...
        self.connect((self.blocks_stream_to_vector_1, 0), (self.blocks_sub_xx_0, 1))
        self.connect((self.blocks_stream_to_vector_1_0_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        ...
        self.connect((self.blocks_uchar_to_float_0, 0), (self.blocks_stream_to_vector_1_0_0, 0))
    ...
    def set_samp_visual(self, samp_visual):
        ...
        self.blocks_multiply_const_vxx_0.set_k(([0.00390625/2]*3*self.samp_visual*self.lines_visual))
    ...
    def set_samp_line(self, samp_line):
        ...
        self.blocks_vector_source_x_0.set_data([1]*self.samp_line, [])
