...
class pal_transmit(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_sink_0_0.set_center_freq(48.25e6, 0)
        ...
        self.blocks_stream_to_vector_0_1 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, samp_line)
        ...
        self.connect((self.blocks_stream_to_vector_0_1, 0), (self.blocks_vector_to_stream_0_0, 0))
